    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="App-contact-container">
          <ul>
            <li>
              <a className="App-icon-link" href="https://github.com/pahnallan" rel="noopener noreferrer" target="_blank">
            ...
            <li>
              <a className="App-icon-link" href="https://www.linkedin.com/in/allanpahn/" rel="noopener noreferrer" target="_blank">
            ...
            <li>   
              <a className="App-icon-link" href="mailto:pahnallan@gmail.com" rel="noopener noreferrer" target="_blank">
            ...
            <li>
              <a className="App-icon-link" href="https://www.instagram.com/allanpahn/" rel="noopener noreferrer" target="_blank">
